...
command = "sudo systemctl status cloudera-scm-agent.service"
grep_pattern = "Active:"
...
def execute_command_and_grep(client, cmd, pattern):
...
if __name__ == "__main__":
    for node in nodes:
        ...
        try:
            ...
            execute_command_and_grep(client, command, grep_pattern)
            client.close()
