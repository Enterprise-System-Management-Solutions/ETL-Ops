...
,"172.16.5.19","172.16.5.33","172.16.5.51","172.16.5.54","172.16.5.58","172.16.5.71","172.16.5.72","172.16.5.73","172.16.5.74","172.16.5.75"
...
script_path = "/etc/yum.repos.d/cloudera-manager.repo"  # Replace with the actual path of the shell script
    ...
    try:
        for node in nodes:
            ...
            try:
                ...
                remote_script_path = "/tmp/agent_backup1.sh"  # Destination path on the remote node
